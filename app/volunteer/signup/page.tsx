...
import { Eye, EyeOff, ArrowRight, CheckCircle, User, Mail, Lock, Award } from "lucide-react"
            ...
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="bg-card p-4 rounded-lg shadow-md border border-border/50 transform transition-all duration-500 hover:scale-105 hover:shadow-lg">
                  <div className="text-2xl font-bold text-primary mb-1 animate-count-up" data-target="5000">
                    0
                  </div>
                  <div className="text-sm text-muted-foreground">Active Volunteers</div>
                </div>
                <div className="bg-card p-4 rounded-lg shadow-md border border-border/50 transform transition-all duration-500 hover:scale-105 hover:shadow-lg">
                  <div className="text-2xl font-bold text-primary mb-1 animate-count-up" data-target="10000">
                    0
                  </div>
          ...
          <ScrollReveal direction="right">
            <Card className="border-none shadow-lg hover-lift transition-all duration-300 parallax-card backdrop-blur-sm bg-background/80">
              <CardHeader className="relative overflow-hidden">
                ...
                <CardTitle className="relative z-10">Create Volunteer Account</CardTitle>
                <CardDescription className="relative z-10">
                  Fill out the form below to create your volunteer account
                </CardDescription>
              ...
              <CardContent>
                ...
                >
                  {formStep === 0 ? (
                    <>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2 group">
                          <Label htmlFor="firstName" className="group-hover:text-primary transition-colors">
                            First Name
                          </Label>
                        ...
                        <div className="space-y-2 group">
                          <Label htmlFor="lastName" className="group-hover:text-primary transition-colors">
                            Last Name
                          </Label>
                          <div className="relative">
                            <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground group-hover:text-primary transition-colors" />
                    ...
                    <>
                      <div className="space-y-2 group">
                        <Label htmlFor="skills" className="group-hover:text-primary transition-colors">
                          Skills (comma separated)
                        </Label>
                        <div className="relative">
                          <Award className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground group-hover:text-primary transition-colors" />
                          <Input
                            id="skills"
                            name="skills"
                            value={formData.skills}
                            onChange={handleInputChange}
                            placeholder="Web Development, Graphic Design, Content Writing"
                            className="pl-10 transition-all duration-300 focus:ring-2 focus:ring-primary border-muted-foreground/20 group-hover:border-primary"
                          />
                        </div>
                      </div>
